  ...
  useEffect(() => {
    const fetchHistory = async () => {
      try {
        ...
        // MOCK: Datos de prueba temporal
        setReviews([
          { id: '1', created_at: '2026-07-20T10:00:00Z', language: 'Python', review_type: 'Errores y Bugs', status: 'Aceptado' },
          { id: '2', created_at: '2026-07-21T14:30:00Z', language: 'JavaScript', review_type: 'Buenas Prácticas', status: 'Regenerado' },
          { id: '3', created_at: '2026-07-21T16:45:00Z', language: 'Java', review_type: 'Rendimiento', status: 'Descartado' },
        ]);
      } finally {
        setLoading(false);
      }
